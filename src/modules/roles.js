...
roleInfo.set("Bodyguard", {alignment: "Town", subfaction: "Protective", def: 0, atk: 2, vests: 2});
...
roleInfo.set("Veteran", {alignment: "Town", subfaction: "Killing", def: 0, atk: 2, alerts: 2});
...
roleInfo.set("Mafioso", {alignment: "Mafia", subfaction: "Killing", def: 0, atk: 1});  // hasGodfather and hasMafioso as instance vars
...
roleInfo.set("Serial Killer", {alignment: "Neutral", subfaction: "Killing", def: 1, atk: 1});
roleInfo.set("Arsonist", {alignment: "Neutral", subfaction: "Killing", def: 1, atk: 0});
